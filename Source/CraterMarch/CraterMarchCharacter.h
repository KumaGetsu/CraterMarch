...
protected:
	...
	// Grab
	UFUNCTION(Server, Reliable, WithValidation) void Server_AttemptGrab(ACraterMarchCharacter* Target);
	UFUNCTION(NetMulticast, Reliable) void Multicast_OnGrabbed(ACraterMarchCharacter* Attacker);
	UFUNCTION(NetMulticast, Reliable) void Multicast_OnGrabReleased();
};